...
document.addEventListener('DOMContentLoaded', function () {
	let typed = new Typed('.typed', {
		...
		loopCount: Infinity, // Número de vezes para repetir (-1 para infinito ou infinity)
	});
});
...
const typed = new Typed('.typing', {
	...
	typeSpeed: 20, // Velocidade de digitação (em milissegundos)
	backSpeed: 30, // Velocidade de remoção (em milissegundos)
	loop: true, // Repetir animação
	loopCount: Infinity, // Número de vezes para repetir (-1 para infinito ou infinity)
})*/
...
>>>>>>> dbdba1b (Update: Unificação de JS e foco em Engenharia de Dados)
